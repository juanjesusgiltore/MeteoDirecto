...
@Composable
fun ElementoTormenta(probab: ProbTormenta, peticionTiempo2ViewModel: PeticionTiempo2ViewModel) {
    val hora=peticionTiempo2ViewModel.getHoraParseada(probab.periodo)
    Column {
        Icon(painter = painterResource(id = R.drawable.thunderstorm_24dp_fill0_wght400_grad0_opsz24 ), contentDescription ="tormenta" )
